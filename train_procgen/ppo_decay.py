# Modified from https://github.com/hill-a/stable-baselines/blob/master/stable_baselines/ppo2/ppo2.py
import time
...
class PPO2_DECAY(ActorCriticRLModel):
    ...
    def learn(self, total_timesteps, callback=None, log_interval=1, tb_log_name="PPO2_DECAY",
